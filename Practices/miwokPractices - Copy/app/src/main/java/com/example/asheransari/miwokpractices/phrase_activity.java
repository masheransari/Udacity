...
//        getActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        WordAdapter adapter = new WordAdapter(this, variable, R.color.phrase);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                {
                    mMediaPlayer = MediaPlayer.create(phrase_activity.this, variableClass.getmAudioResourceID());
                    mMediaPlayer.start();
                }
                mMediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                    ...
                    public void onCompletion(MediaPlayer mp) {
                        releasePlayer();
                        Toast.makeText(phrase_activity.this, "I am Done",Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
