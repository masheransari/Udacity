...
//        getActionBar().setDisplayHomeAsUpEnabled(true);
    ...
    audioManager = (AudioManager) getSystemService(Context.AUDIO_SERVICE);
        ...
        WordAdapter adapter = new WordAdapter(this, variableClasses, R.color.family);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                {
                    mediaPlayer = MediaPlayer.create(family_activity.this, variableClasses1.getmAudioResourceID());
                    mediaPlayer.start();
                }
                mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                    ...
                    public void onCompletion(MediaPlayer mp) {
                        releasePlayer();
                        Toast.makeText(family_activity.this, "I am Done!!",Toast.LENGTH_SHORT).show();
                    }
                });
